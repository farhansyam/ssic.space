<x-layouts.admin title="Edit Kelas">
    <div class="mb-6 flex items-center gap-3">
        ...
        <div>
            <h2 class="font-display text-2xl font-semibold text-slate-800">Edit Kelas</h2>
            <p class="mt-0.5 text-sm text-slate-500">Perbarui informasi kelas {{ $kelas->title }}.</p>
        </div>
    </div>

    @include('admin.kelas._form', ['action' => route('admin.kelas.update', $kelas), 'method' => 'PUT', 'kelas' => $kelas])
</x-layouts.admin>
