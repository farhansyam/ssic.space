<x-layouts.admin title="Tambah Kelas">
    <div class="mb-6 flex items-center gap-3">
        ...
        <div>
            <h2 class="font-display text-2xl font-semibold text-slate-800">Tambah Kelas</h2>
            <p class="mt-0.5 text-sm text-slate-500">Buat kelas / program belajar baru.</p>
        </div>
    </div>

    @include('admin.kelas._form', ['action' => route('admin.kelas.store'), 'method' => 'POST', 'kelas' => null])
</x-layouts.admin>
