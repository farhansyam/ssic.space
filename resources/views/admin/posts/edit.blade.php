<x-layouts.admin title="Edit Artikel">
    <div class="mb-6 flex items-center gap-3">
        ...
        <div>
            <h2 class="font-display text-2xl font-semibold text-slate-800">Edit Artikel</h2>
            <p class="mt-0.5 text-sm text-slate-500">Perbarui artikel {{ $post->title }}.</p>
        </div>
    </div>

    @include('admin.posts._form', ['action' => route('admin.posts.update', $post), 'method' => 'PUT', 'post' => $post, 'categories' => $categories, 'tags' => $tags])
</x-layouts.admin>
