<x-layouts.admin title="Tulis Artikel">
    <div class="mb-6 flex items-center gap-3">
        ...
        <div>
            <h2 class="font-display text-2xl font-semibold text-slate-800">Tulis Artikel</h2>
            <p class="mt-0.5 text-sm text-slate-500">Buat artikel blog baru.</p>
        </div>
    </div>

    @include('admin.posts._form', ['action' => route('admin.posts.store'), 'method' => 'POST', 'post' => null, 'categories' => $categories, 'tags' => $tags])
</x-layouts.admin>
