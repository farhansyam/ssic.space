<x-layouts.admin title="Edit Kegiatan">
    <div class="mb-6 flex items-center gap-3">
        ...
        <div>
            <h2 class="font-display text-2xl font-semibold text-slate-800">Edit Kegiatan</h2>
            <p class="mt-0.5 text-sm text-slate-500">Perbarui informasi kegiatan {{ $event->title }}.</p>
        </div>
    </div>

    @include('admin.events._form', ['action' => route('admin.events.update', $event), 'method' => 'PUT', 'event' => $event, 'availableForms' => $availableForms, 'currentFormId' => $currentFormId])
</x-layouts.admin>
