<x-layouts.admin title="Tambah Divisi">
    <div class="mb-6 flex items-center gap-3">
        ...
        <div>
            <h2 class="font-display text-2xl font-semibold text-slate-800">Tambah Divisi</h2>
            <p class="mt-0.5 text-sm text-slate-500">Buat divisi baru untuk komunitas.</p>
        </div>
    </div>

    @include('admin.divisions._form', ['action' => route('admin.divisions.store'), 'method' => 'POST', 'division' => null])
</x-layouts.admin>
