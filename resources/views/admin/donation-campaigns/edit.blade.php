<x-layouts.admin title="Edit Campaign">
    <div class="mb-6 flex items-center gap-3">
        ...
        <div>
            <h2 class="font-display text-2xl font-semibold text-slate-800">Edit Campaign</h2>
            <p class="mt-0.5 text-sm text-slate-500">Perbarui informasi campaign {{ $campaign->title }}.</p>
        </div>
    </div>

    @include('admin.donation-campaigns._form', ['action' => route('admin.donation-campaigns.update', $campaign), 'method' => 'PUT', 'campaign' => $campaign])
</x-layouts.admin>
