<x-layouts.admin title="Tambah Campaign">
    <div class="mb-6 flex items-center gap-3">
        ...
        <div>
            <h2 class="font-display text-2xl font-semibold text-slate-800">Tambah Campaign</h2>
            <p class="mt-0.5 text-sm text-slate-500">Buat campaign donasi baru.</p>
        </div>
    </div>

    @include('admin.donation-campaigns._form', ['action' => route('admin.donation-campaigns.store'), 'method' => 'POST', 'campaign' => null])
</x-layouts.admin>
