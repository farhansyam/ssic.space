<x-layouts.admin title="Tambah Slide">
    <div class="mb-6 flex items-center gap-3">
        ...
        <div>
            <h2 class="font-display text-2xl font-semibold text-slate-800">Tambah Slide</h2>
            <p class="mt-0.5 text-sm text-slate-500">Tambah slide baru ke hero carousel.</p>
        </div>
    </div>

    @include('admin.hero-banners._form', ['action' => route('admin.hero-banners.store'), 'method' => 'POST', 'banner' => null])
</x-layouts.admin>
