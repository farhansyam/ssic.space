<x-layouts.admin title="Edit Popup">
    <div class="mb-6 flex items-center gap-3">
        ...
        <div>
            <h2 class="font-display text-2xl font-semibold text-slate-800">Edit Popup</h2>
            <p class="mt-0.5 text-sm text-slate-500">Perbarui popup {{ $popup->title }}.</p>
        </div>
    </div>

    @include('admin.popups._form', ['action' => route('admin.popups.update', $popup), 'method' => 'PUT', 'popup' => $popup])
</x-layouts.admin>
